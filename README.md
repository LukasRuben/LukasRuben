...
|----------|------|---------------|---------------|
| [Application Licensing Server](https://github.com/LukasRuben/py_juceAuth) | Public | Server for distribution and validation of cryptographically signed software licenses. | Python, Flask, Docker, Postgres, PHP |
